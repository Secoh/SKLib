...
#ifndef SKLIB_INCLUDED_UTILITY_MACRO_OVERLOAD_HPP
#define SKLIB_INCLUDED_UTILITY_MACRO_OVERLOAD_HPP

// Provides means and example how to declare C macros, "overloaded" by number of parameters.
// This is internal SKLib file and must NOT be included directly.

#define SKLIB_AUX_EXPAND_COMMA(...) __VA_ARGS__

#ifdef _MSVC_TRADITIONAL
#if _MSVC_TRADITIONAL

#undef SKLIB_AUX_EXPAND_COMMA
#define SKLIB_AUX_EXPAND_COMMA(that) that
...
#define SKLIB_MACRO_SELECT_ONE_TWO(one,two,...) SKLIB_AUX_EXPAND_COMMA(SKLIB_INTERNAL_MACRO_SUBSTITUTE_ONE_TWO(__VA_ARGS__, two, one, dummy)(__VA_ARGS__))
...
#endif // SKLIB_INCLUDED_UTILITY_MACRO_OVERLOAD_HPP
