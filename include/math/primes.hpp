...
// Provides functions related to prime numbers search
...
SKLIB_INTERNAL_TEMPLATE_IF_UINT_T constexpr T prime_candidate(::sklib::internal::do_not_deduce<T> idx)
{
...
// TODO: Proof?
SKLIB_INTERNAL_TEMPLATE_IF_UINT_T constexpr T prime_candidate_to_index(T p)
{
    return (p - 2 - (p & 1)) / 3;
}
