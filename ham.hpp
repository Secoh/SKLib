...
namespace sklib
{
    ...
    static constexpr void generate_table(const std::initializer_list<std::pair<char, const char*>>& config, ::sklib::internal::encapsulated_array_type<uint8_t, ham_morse_code_point_range>& table)
    {
    ...
    {
        ::sklib::internal::encapsulated_array_type<uint8_t, ham_morse_code_point_range> R{ 0 };
    ...
    {
        static constexpr ::sklib::internal::encapsulated_array_type<uint8_t, ham_morse_code_point_range> Codes = create_standard_latin_table();
    };

    struct ham_morse_code_table
    {
        const ::sklib::internal::encapsulated_array_type<uint8_t, ham_morse_code_point_range> Codes = create_standard_latin_table();
